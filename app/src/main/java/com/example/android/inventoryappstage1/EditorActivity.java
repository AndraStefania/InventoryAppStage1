...
import static com.example.android.inventoryappstage1.data.InvContract.InvEntry.COLUMN_NAME;
import static com.example.android.inventoryappstage1.data.InvContract.InvEntry.COLUMN_PRICE;
import static com.example.android.inventoryappstage1.data.InvContract.InvEntry.COLUMN_QUANTITY;
import static com.example.android.inventoryappstage1.data.InvContract.InvEntry.COLUMN_SUPPLIER_NAME;
import static com.example.android.inventoryappstage1.data.InvContract.InvEntry.COLUMN_SUPPLIER_PHONE;
...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertProduct() {
        ...
        if (supplierNameString.trim().equals("")) {
            ...
            values.put(InvContract.InvEntry.COLUMN_SUPPLIER_NAME, supplierNameString);
        }
        ...
        long newRowId = db.insert(InvContract.InvEntry.TABLE_NAME, null, values);
